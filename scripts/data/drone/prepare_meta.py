...
def main():
    ...
    rootdir = os.path.join(rootdir, 'datasets/DRONE')

    print('Path for the root folder is:')
    print(rootdir)

    hr_train = os.path.join(rootdir, 'DRONE_train_HR_sub')
    meta_hr = os.path.join(rootdir, 'DRONE_meta_HR_sub')

    lr_train_roots = ['DRONE_train_LR_bicubic/X50_9_sub']
    meta_lr_roots = ['DRONE_meta_LR_bicubic/X50_9_sub']
